...
baseComponent({
    ...
    computed: {
        ss: [
            'prefixCls, pullingText, pullingIcon, disablePullingRotation, refreshingText, refreshingIcon, visible, active, refreshing, tail, prefixLCls, loading, noData, theme',
            function (
                prefixCls,
                pullingText,
                pullingIcon,
                ...
                const content = cx(`${prefixCls}__content`, {
                    [`${prefixCls}__content--text`]: pullingText || refreshingText
                });
                const iconPulling = cx(`${prefixCls}__icon-pulling`, {
        ...
        onScroll(n) {
            ...
            query
                ...
                .boundingClientRect((res) => {
                    ...
                    const { oldContentHeight, windowHeight, distance, loading, noData } = this.data;
